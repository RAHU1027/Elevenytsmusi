...
class Config:
    def __init__(self):
        ...
        # Images
        self.DEFAULT_THUMB: str = getenv("DEFAULT_THUMB", "https://ibb.co/YFn46rhm")
        self.PING_IMG: str = getenv("PING_IMG", "https://ibb.co/YFn46rhm")
        self.START_IMG: str = getenv("START_IMG", "https://ibb.co/YFn46rhm")
        self.RADIO_IMG: str = getenv("RADIO_IMG", "https://ibb.co/YFn46rhm")
